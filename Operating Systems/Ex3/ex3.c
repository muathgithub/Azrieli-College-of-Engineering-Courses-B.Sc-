// Program Name: Mini Shell That Support Two Pipes
...
char *getSectionedStr(const char *, const int *, const int *);
...
char *getSectionedStr(const char *sentence, const int *wordStartInd, const int *wordEndInd) {
    int i, j;
...
void printStatistics(const int *commandsNum, const int *totalPipesNum) {
...
void freeAll(char **sectionsArrayPointer, const int *sectionsArrayLen) {
